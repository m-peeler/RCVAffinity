 ...
 */
public class DataNSW2019 implements DataInterface {
	...
	public DataNSW2019 (String namesFile, String dataFile) {
	...
	/**
	 * A list of all primary parties in an above the lien group group, as defined
